      ...
      >
        <div className="w-7xl text-[#EBE7D9] flex justify-between items-center">
          <div className="flex gap-x-9 font-[Montserrat] font-semibold relative">
            ...
            <Link to={"/services"} search={{ page: 1 }}>
              {t("navbar.links.services")}
            </Link>
            <Link to={"/shop"} search={defaultShopSearchFilters}>
              {t("navbar.links.shop")}
            </Link>
            <Link to={"/info"}>{t("navbar.links.about")}</Link>
            <Link to={"/projects"}>{t("navbar.links.projects")}</Link>
          </div>
          <div
          ...
          <div className="flex gap-x-7 font-[Montserrat] font-semibold items-center text-xs leading-[14px]">
            ...
            >
              ...
              <div
                className={clsx(
                  "absolute top-[2.5rem] rounded-lg bg-(--foreground) transition-opacity duration-200 min-w-[80px]",
                  {
                ...
                {!isLoading &&
                  (data ? (
                    <div className="block w-full">
                      <Link
                        to="/profile"
                        className="block p-3 cursor-pointer w-full text-left"
                      >
                        {t("navbar.popup_menu.profile")}
                      </Link>
                      <div
                        onClick={() => {
                          /* handle logout */
                        }}
                        className="block p-3 cursor-pointer w-full text-left break-keep"
                      >
            ...
            <Link to={"/cart"} className="max-w-[100px]">
            ...
            <div style={{ cursor: "pointer" }} className="max-w-[50px]">
              <div className="" onClick={() => handleLocaleChange()}>
                <img
                  className="w-[30px]"
                  alt="Language icon"
                  src={`../../src/assets/${localeIconPath}`}
                />
              </div>
            </div>
          </div>
...
export function NavbarScheduleComponent() {
  ...
  return (
    ...
    >
      <div className="ext-left" style={{ gridArea: "a1" }}>
        {t("navbar.work_schedule.row1.left")}
      </div>
      <div className="text-right" style={{ gridArea: "b1" }}>
        {t("navbar.work_schedule.row1.right")}
      </div>
      <div className="ext-left" style={{ gridArea: "a2" }}>
        {t("navbar.work_schedule.row2.left")}
      </div>
      <div className="text-right" style={{ gridArea: "b2" }}>
        {t("navbar.work_schedule.row2.right")}
      </div>
      <div className="text-left" style={{ gridArea: "a3" }}>
        {t("navbar.work_schedule.row3.left")}
      </div>
      <div className="text-right" style={{ gridArea: "b3" }}>
        {t("navbar.work_schedule.row3.right")}
      </div>
      <div className="text-right" style={{ gridArea: "a4" }}>
        {t("navbar.work_schedule.phone")}
      </div>
    </div>
  );
}
...
export function LoginForm({
  ...
  const onSubmit: SubmitHandler<LoginInputs> = async (data) => {
    try {
      ...
      const decoded = jwtDecode<{ user_id: number; email: string }>(
      ...
      >
        <div className="text-(--foreground) font-[Montserrat] w-full">
          <label className="block text-sm font-semibold">
            {t("navbar.modals.login.username_input.label")}
          </label>
          <div className="mt-2 text-(--foreground) h-[51px] flex border-(--foreground) border-[2px] rounded-xl bg-[#E5E0D2]">
            ...
            <input
              ...
              type="text"
              placeholder={t("navbar.modals.login.username_input.placeholder")}
        ...
        <div className="text-(--foreground) font-[Montserrat] w-full">
          <label className="block text-sm font-semibold">
            {t("navbar.modals.login.password_input.label")}
          </label>
          <div className="mt-2 text-(--foreground) h-[51px] flex border-(--foreground) border-[2px] rounded-xl bg-[#E5E0D2]">
            <div className="mr-3 ml-3">
            ...
            <input
              ...
              type="password"
              placeholder={t("navbar.modals.login.password_input.placeholder")}
              className="w-full outline-none pr-3 pb-3 pt-3"
            />
          </div>
          <span className="text-xs mt-2 text-(--accent)">
        ...
        <span>
          {t("navbar.modals.login.modal_switch.text")}{" "}
          <span
            onClick={() => onModalModeChange()}
            className="cursor-pointer underline decoration-[1.5px]"
          >
            {t("navbar.modals.login.modal_switch.trigger")}
          </span>
        </span>
    ...
    <div className="w-full">
      ...
      >
        ...
        <div className="text-(--foreground) font-[Montserrat] w-full">
          ...
          <label className="block text-sm font-semibold">
            {" "}
            {t("navbar.modals.register.username_input.label")}{" "}
          </label>{" "}
          <div className="mt-2 text-(--foreground) h-[51px] flex border-(--foreground) border-[2px] rounded-xl bg-[#E5E0D2]">
            {" "}
            <div className="mr-3 ml-3">
            ...
            <input
              ...
              type="text"
              placeholder={t(
                "navbar.modals.register.username_input.placeholder"
              )}
              className="w-full outline-none pr-3 pb-3 pt-3"
            />{" "}
          </div>{" "}
        ...
        <div className="text-(--foreground) font-[Montserrat] w-full">
          ...
          <label className="block text-sm font-semibold">
            {" "}
            {t("navbar.modals.register.email_input.label")}{" "}
          </label>{" "}
          <div className="mt-2 text-(--foreground) h-[51px] flex border-(--foreground) border-[2px] rounded-xl bg-[#E5E0D2]">
            {" "}
            <div className="mr-3 ml-3">
            ...
            <input
              ...
              type="text"
              placeholder={t("navbar.modals.register.email_input.placeholder")}
              className="w-full outline-none pr-3 pb-3 pt-3"
            />{" "}
          </div>{" "}
          <span className="text-xs mt-2 text-(--accent)">
        ...
        <div className="text-(--foreground) font-[Montserrat] w-full">
          ...
          <label className="block text-sm font-semibold">
            {" "}
            {t("navbar.modals.register.password_input.label")}{" "}
          </label>{" "}
          <div className="mt-2 text-(--foreground) h-[51px] flex border-(--foreground) border-[2px] rounded-xl bg-[#E5E0D2]">
            {" "}
            <div className="mr-3 ml-3">
            ...
            <input
              ...
              type="password"
              placeholder={t(
                "navbar.modals.register.password_input.placeholder"
              )}
              className="w-full outline-none pr-3 pb-3 pt-3"
            />{" "}
          </div>{" "}
        ...
        <div className="text-(--foreground) font-[Montserrat] w-full">
          ...
          <label className="block text-sm font-semibold">
            {" "}
            {t(
              "navbar.modals.register.confirm_password_input.placeholder"
            )}{" "}
          </label>{" "}
          <div className="mt-2 text-(--foreground) h-[51px] flex border-(--foreground) border-[2px] rounded-xl bg-[#E5E0D2]">
            {" "}
            ...
            <input
              ...
              type="password"
              placeholder={t(
                "navbar.modals.register.confirm_password_input.label"
              )}
              className="w-full outline-none pr-3 pb-3 pt-3"
            />{" "}
          </div>{" "}
        ...
        <span>
          {" "}
          {t("navbar.modals.register.modal_switch.text")}{" "}
          <span
            onClick={() => onModalModeChange()}
            className="cursor-pointer underline decoration-[1.5px]"
          >
            {" "}
            {t("navbar.modals.register.modal_switch.trigger")}{" "}
          </span>{" "}
        </span>{" "}
        <div className="flex items-center justify-end font-[Montserrat] mt-[1rem]">
          {" "}
